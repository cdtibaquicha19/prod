...
from .models import Categoria, Producto, UnidadMedida, subCategoria , Marca


from .forms import CategoriaForm, ProductoForm ,SubCategoriaForm , MarcaForm, UMForm
...
class SubCategoriaView(LoginRequiredMixin,generic.ListView):
    ...
    queryset = subCategoria.objects.order_by('id')
    context_object_name = "obj"
    login_url = 'bases:login'
